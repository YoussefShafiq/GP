            ...
            <AnimatePresence>
                {showDeleteAttachmentConfirmation && (
                    <motion.div initial={{ opacity: 0 }} animate={{ opacity: 1 }} exit={{ opacity: 0 }} className="fixed inset-0 flex items-center justify-center bg-black bg-opacity-50 z-50">
                        <motion.div initial={{ scale: 0.8, opacity: 0 }} animate={{ scale: 1, opacity: 1 }} exit={{ scale: 0.8, opacity: 0 }} className="bg-white dark:bg-dark1 p-6 rounded-lg shadow-lg">
                            <h2 className="text-lg font-semibold mb-4">Are you sure you want to delete this attachment?</h2>
                            <div className="flex justify-end gap-3">
                                <button onClick={cancelDeleteAttachment} className="px-4 py-2 bg-gray-300 dark:bg-dark2 rounded-lg hover:bg-gray-400">Cancel</button>
