import { ChevronDown, ChevronUp, CirclePlus, CircleUserRound, ClipboardList, DoorOpen, Headset, House, LayoutDashboard, LayoutGrid, LibraryBig, ListCollapse, MessageCircleMore, NotebookPen, PanelLeft, Ticket, Users, X } from 'lucide-react';
...
export default function Sidebar() {
  ...
  return (
    <>
      ...
      {/* Sidebar */}
      <div className={`${!sidebarOpen ? "w-0 md:w-16" : "w-48 border-e md:border-none"} overflow-hidden transition-all h-[calc(100vh-48px)] fixed left-0 z-50 bg-darkblue dark:bg-darklayout flex flex-col px-0 text-white mt-12 text-[13px]`}>
        <div className="px-3 pb-3 border-b">
          ...
          <ul className={`space-y-1 `}>
            ...
            <li><NavLink className={`px-2 rounded-3xl ${!sidebarOpen ? "" : "pe-4 "} py-[6px] block`} to={"myteams"} ><div className={`flex items-center ${!sidebarOpen ? "justify-center" : ""} space-x-2 capitalize `} ><Users /><h2 className={`${!sidebarOpen ? "hidden" : ""} `} >my teams</h2></div></NavLink></li>
            ...
            <li><NavLink className={`px-2 rounded-3xl ${!sidebarOpen ? "" : "pe-4 "} py-[6px] block`} to={"chat"} ><div className={`flex items-center ${!sidebarOpen ? "justify-center" : ""} space-x-2 capitalize `} ><MessageCircleMore /><h2 className={`${!sidebarOpen ? "hidden" : ""} `} >chat</h2></div></NavLink></li>
