      ...
      <div className={`${!sidebarOpen ? "w-16" : "w-48"} transition-all h-[calc(100vh-48px)] fixed left-0 z-40 bg-darkblue flex flex-col px-0 text-white mt-12 text-[13px]`}>
        <div className="px-3 pb-3 border-b">
          ...
          <ul className={`space-y-1 `}>
            ...
            <li><NavLink className={`px-2 rounded-3xl ${!sidebarOpen ? "" : "pe-4 "} py-[6px] block`} to={"chat"} ><div className={`flex items-center ${!sidebarOpen ? "justify-center" : ""} space-x-2 capitalize `} ><Headset /><h2 className={`${!sidebarOpen ? "hidden" : ""} `} >chat</h2></div></NavLink></li>
