...
export default function Materials() {
    ...
    return <>
        <div className="p-5">
            {/* path */}
            <div className='text-black dark:text-white flex justify-between items-center h-10 px-5 mb-5'>
                        ...
                        <div key={project.id} onClick={() => {
                            ...
                            <div className="">
                                <div className="flex items-center gap-2">
                                    ...
                                    <h2 className="text-lg font-bold text-gray-800 dark:text-white">{project.name}</h2>
                                </div>
