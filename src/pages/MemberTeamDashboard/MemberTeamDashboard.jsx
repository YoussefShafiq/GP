                        ...
                        <div className="w-2/3">
                            <DonutChart
                                ...
                                dataPoints={[
                                    ...
                                    teamDashboard?.task_counts?.total || 0
                                ]}
                                centerText={calculatePercentage(
                                    teamDashboard?.task_alerts?.overdue,
                                    teamDashboard?.task_counts?.total
                                )}
                                fontSize={26}
                            />
                        </div>
                        ...
                        <div className="w-2/3">
                            <DonutChart
                                ...
                                dataPoints={[
                                    ...
                                    (teamDashboard?.task_counts?.total || 0) - (teamDashboard?.task_alerts?.at_risk || 0)
                                ]}
                                centerText={calculatePercentage(
                    ...
                    <div className="bg-base dark:bg-dark1 shadow-lg rounded-2xl">
                        ...
                        <div className="flex">
                            <div className="w-full p-5">
                                <LineChart
                                    key={`monthly-duration-${selectedDashboardTeam}`}
                        ...
                        <div className="py-4 px-4 w-1/6">
                            <DonutChart
                                ...
                                dataPoints={[
                                    ...
                                    (teamDashboard?.task_counts?.total || 0) - (teamDashboard?.task_counts?.pending || 0)
                                ]}
                                centerText={calculatePercentage(
                        ...
                        <div className="py-4 px-4 w-1/6">
                            <DonutChart
                                ...
                                dataPoints={[
                                    ...
                                    (teamDashboard?.task_counts?.total || 0) - (teamDashboard?.task_counts?.in_progress || 0)
                                ]}
                                centerText={calculatePercentage(
                        ...
                        <div className="py-4 px-4 w-1/6">
                            <DonutChart
                                ...
                                dataPoints={[
                                    ...
                                    (teamDashboard?.task_counts?.total || 0) - (teamDashboard?.task_counts?.completed || 0)
                                ]}
                                centerText={calculatePercentage(
                        ...
                        <div className="py-4 px-4 w-1/6">
                            <DonutChart
                                ...
                                dataPoints={[
                                    ...
                                    (teamDashboard?.task_counts?.total || 0) - (teamDashboard?.task_counts?.in_review || 0)
                                ]}
                                centerText={calculatePercentage(
                        ...
                        <div className="py-4 px-4 w-1/6">
                            <DonutChart
                                ...
                                dataPoints={[
                                    ...
                                    (teamDashboard?.task_counts?.total || 0) - (teamDashboard?.task_counts?.cancelled || 0)
                                ]}
                                centerText={calculatePercentage(
                        ...
                        <div className="py-4 px-4 w-1/6">
                            <DonutChart
                                ...
                                dataPoints={[
                                    ...
                                    (teamDashboard?.task_counts?.total || 0) - (teamDashboard?.task_counts?.on_hold || 0)
                                ]}
                                centerText={calculatePercentage(
